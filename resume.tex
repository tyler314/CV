...
{\footnotesize
	...
	\ttab- Developed Python application on another team that moved their locally stored data and user accounts to Bluemix, IBM's \\
	\ttab cloud platform as a service. \\
	\ttab- Designed and engineered a web application from the ground up using HTML, CSS, Angular, and Bootstrap. \\
	\ttab Responsible for the front-end, and worked alongside my team members as they developed the other layers of the application. \\
...
{\footnotesize
	\ttab- Inherited former Ph.D. candidate's Python application, and enhanced it to communicate with additional instrumentation \ttab added to the experiment. \\
