...
\underline{Computer Skills} - Python, Golang, Java, Git workflow, Linux, Cloud Services (AWS, GCP). \\[5mm]
...
{\footnotesize
	...
	\ttab - Added support for implicitly setting the default value of a column
	to null without causing a backfill operation, removing \ttab unnecessary and costly operations. \\
